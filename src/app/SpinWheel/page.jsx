...
export default function SpinWheel() {
  ...
  return (
    <section className="bg-[#0b0e15] flex items-center justify-center h-[600] p-2">
      <div className="max-w-7xl w-full grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        ...
        <div className="text-white text-center md:text-left px-4 md:px-0 space-y-6">
          ...
          {/* Result message & button BELOW text */}
          {result && (
            <div
            ...
            >
              ...
              {!["Try Again", "Free Spin"].includes(result) && (
                <a
                  href="https://www.bg678p.com/#/pages/login/register?invitationCode=71794604827"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="mt-2 inline-block bg-red-600 hover:bg-red-700 text-white font-semibold rounded-lg px-4 py-2 shadow transition duration-300 w-full max-w-xs text-center text-sm"
                >
        ...
        <div className="relative w-80 h-80 sm:w-96 sm:h-96 mx-auto">
          ...
          {/* Pointer */}
          <div
            className="absolute top-0 left-1/2 w-0 h-0 border-l-10 border-r-10 border-b-16 border-b-pink-500 transform -translate-x-1/2 -translate-y-1/2"
